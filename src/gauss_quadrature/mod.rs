...
//! the form $f(x) e^{-x}$ over the positive x-axis $\lbrace x : x > 0 \rbrace$,
//! Gauss-Hermite used to integrate a function of the form $f(x) e^{-x^2}$ over the entire x-axis, $\lbrace x : -\infty < x < \infty \rbrace$,
