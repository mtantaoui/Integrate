...
fn test_min_h_zero() {
    let f = |x: f64| x.exp();
    let _ = adaptive_simpson_method(f, 0.0, 1.0, 0.0, 0.1).unwrap();
}
...
fn test_min_h_negative_infinite() {
    let f = |x: f64| x.exp();
    let _ = adaptive_simpson_method(f, 0.0, 1.0, f64::NEG_INFINITY, 0.1).unwrap();
}
...
fn test_min_h_positive_infinite() {
    let f = |x: f64| x.exp();
    let _ = adaptive_simpson_method(f, 0.0, 1.0, f64::INFINITY, 0.1).unwrap();
}
...
fn test_min_h_nan() {
    let f = |x: f64| x.exp();
    let _ = adaptive_simpson_method(f, 0.0, 1.0, f64::NAN, 0.1).unwrap();
}
...
fn test_tolerance_zero() {
    let f = |x: f64| x.exp();
    let _ = adaptive_simpson_method(f, 0.0, 1.0, 0.1, 0.0).unwrap();
}
...
fn test_tolerance_negative_infinite() {
    let f = |x: f64| x.exp();
    let _ = adaptive_simpson_method(f, 0.0, 1.0, 0.1, f64::NEG_INFINITY).unwrap();
}
...
fn test_tolerance_positive_infinite() {
    let f = |x: f64| x.exp();
    let _ = adaptive_simpson_method(f, 0.0, 1.0, 0.1, f64::INFINITY).unwrap();
}
...
fn test_tolerance_nan() {
    let f = |x: f64| x.exp();
    let _ = adaptive_simpson_method(f, 0.0, 1.0, 0.1, f64::NAN).unwrap();
}
